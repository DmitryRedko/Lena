...
namespace cfl
{
  ...
  /**
   * Constructs similar model given the implementation of rollback
   * operator in the setup of the base model. Deep copies of the inputs
   * will be kept inside of the result.
   *
   * @param rTargetRollback Runs rollback operator for the target model in the base model.
